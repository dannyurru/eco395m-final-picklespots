...
<title>Final Project for ECO395M</title>
<style>
    .subtitle {
        font-weight: bold;
        font-size: 24px;
...
<div class="subtitle">Final Project for ECO395M</div>
<div class="authors">By Divya Salian, Nicolas Salas, Danny Urrutia, Juan Guerra, Jisoo Yoo, Sindhuj Thapa</div>
