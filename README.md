...
<li>The incoproration of interactive information about each court, such as current distance from user, could be displayed onto the interface to enhance the user's experience.</li>
